...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="gameCmsJobinfo.orders.label" default="orders"/></td>

                <td valign="top" class="value">${fieldValue(bean: gameCmsJobinfoInstance, field: "orders")}</td>
    ...
    <div class="buttons">
        <g:form>
            ...
            <span class="button"><g:actionSubmit class="edit" action="edit" value="${message(code: 'default.button.edit.label', default: 'Edit')}"/></span>
             <span class="button"><g:actionSubmit class="view" action="view" value="${message(code: 'default.button.view.label', default: 'View')}"/></span>
