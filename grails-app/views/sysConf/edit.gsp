...
<div class="body">
    ...
    <g:hasErrors bean="${sysConfInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${sysConfInstance}" var="error">
    ...
    <g:form method="post" >
        <g:hiddenField name="id" value="${sysConfInstance?.id}" />
        <g:hiddenField name="version" value="${sysConfInstance?.version}" />
        <div class="dialog">
            <fieldset class="form">
